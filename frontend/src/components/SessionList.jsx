        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <button
                    ...
                    className="text-xs bg-white/5 hover:bg-white/10 text-white px-3 py-1.5 rounded-lg border border-white/10 transition-colors"
                >
            ...
            {isLogging && (
                <form onSubmit={handleManualLog} className="bg-black/40 border border-white/10 rounded-xl p-4 space-y-4 animate-in slide-in-from-top-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-black/50 border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:border-red-500/50 outline-none"
                            />
                        </div>
                        <div>
                    ...
                    <button type="submit" className="w-full bg-red-600 hover:bg-red-700 text-white py-2 rounded-lg text-sm font-medium transition-colors">
                        Save Session
                    </button>
                </form>
            )}
            ...
            {loading ? (
                <div className="space-y-3">
                    {[1, 2, 3].map((i) => (
                        <div key={i} className="h-24 bg-white/5 border border-white/5 rounded-lg animate-pulse"></div>
                    ))}
                </div>
            ) : sessions.length === 0 ? (
                ...
                <div className="space-y-3">
                    {sessions.map((session) => (
                        <div key={session.id} className="bg-black/40 border border-white/5 rounded-xl p-4 hover:border-red-600/30 transition-all duration-300">
