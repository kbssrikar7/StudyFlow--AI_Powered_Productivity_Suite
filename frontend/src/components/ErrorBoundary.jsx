        ...
        if (this.state.hasError) {
            return (
                <div className="min-h-screen bg-zinc-900 text-zinc-100 p-8 flex flex-col items-center justify-center">
                    ...
                    <div className="bg-zinc-800 p-6  max-w-2xl w-full overflow-auto">
                    ...
                    <button
                        ...
                        className="mt-8 px-6 py-3 bg-zinc-100 text-zinc-900  font-medium hover:bg-white transition-colors"
                    >
                        Reload Page
                    </button>
                </div>
